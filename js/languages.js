...
export const SPRACHEN = [
  ...
  { code: 'ak-GH', name: 'Akan', schrift: 'latein', qualitaet: 'gruen' },
  ...
  { code: 'as-IN', name: 'Assamesisch', schrift: 'indisch', qualitaet: 'gruen' },
  { code: 'ay-BO', name: 'Aymara', schrift: 'latein', qualitaet: 'gruen' },
  { code: 'bm-ML', name: 'Bambara', schrift: 'latein', qualitaet: 'gruen' },
  { code: 'ba-RU', name: 'Baschkirisch', schrift: 'kyrillisch', qualitaet: 'gruen' },
  ...
  { code: 'gn-PY', name: 'Guarani', schrift: 'latein', qualitaet: 'gruen' },
  ...
  { code: 'ig-NG', name: 'Igbo', schrift: 'latein', qualitaet: 'gruen' },
  ...
  { code: 'jv-ID', name: 'Javanisch', schrift: 'latein', qualitaet: 'gruen' },
  ...
  { code: 'ks-IN', name: 'Kaschmiri', schrift: 'indisch', qualitaet: 'gruen' },
  { code: 'km-KM', name: 'Khmer', schrift: 'khmer', qualitaet: 'gruen' },
  { code: 'ki-KE', name: 'Kikuyu', schrift: 'latein', qualitaet: 'gruen' },
  { code: 'rw-RW', name: 'Kinyarwanda', schrift: 'latein', qualitaet: 'gruen' },
  { code: 'rn-BI', name: 'Kirundi', schrift: 'latein', qualitaet: 'gruen' },
  { code: 'kg-CD', name: 'Kongo (Kikongo)', schrift: 'latein', qualitaet: 'gruen' },
  { code: 'ko-KR', name: 'Koreanisch', schrift: 'koreanisch', qualitaet: 'gruen' },
  { code: 'co-FR', name: 'Korsisch', schrift: 'latein', qualitaet: 'gruen' },
  ...
  { code: 'li-NL', name: 'Limburgisch', schrift: 'latein', qualitaet: 'gruen' },
  { code: 'ln-CD', name: 'Lingala', schrift: 'latein', qualitaet: 'gruen' },
  ...
  { code: 'ml-IN', name: 'Malayalam', schrift: 'indisch', qualitaet: 'gruen' },
  ...
  { code: 'mr-IN', name: 'Marathi', schrift: 'indisch', qualitaet: 'gruen' },
  ...
  { code: 'nb-NO', name: 'Norwegisch (Bokmål)', schrift: 'latein', qualitaet: 'gruen' },
  { code: 'nn-NO', name: 'Norwegisch (Nynorsk)', schrift: 'latein', qualitaet: 'gruen' },
  { code: 'ny-MW', name: 'Chichewa (Nyanja)', schrift: 'latein', qualitaet: 'gruen' },
  { code: 'or-IN', name: 'Odia (Oriya)', schrift: 'indisch', qualitaet: 'gruen' },
  { code: 'oc-FR', name: 'Okzitanisch', schrift: 'latein', qualitaet: 'gruen' },
  { code: 'om-ET', name: 'Oromo', schrift: 'latein', qualitaet: 'gruen' },
  ...
  { code: 'sa-IN', name: 'Sanskrit', schrift: 'indisch', qualitaet: 'gruen' },
  { code: 'sc-IT', name: 'Sardisch', schrift: 'latein', qualitaet: 'gruen' },
  ...
  { code: 'sd-PK', name: 'Sindhi', schrift: 'arabisch', qualitaet: 'gelb' },
  ...
  { code: 'nr-ZA', name: 'Süd-Ndebele', schrift: 'latein', qualitaet: 'gruen' },
  { code: 'su-ID', name: 'Sundanesisch', schrift: 'latein', qualitaet: 'gruen' },
  ...
  { code: 'ss-SZ', name: 'Swati (Siswati)', schrift: 'latein', qualitaet: 'gruen' },
  ...
  { code: 'tt-RU', name: 'Tatarisch', schrift: 'kyrillisch', qualitaet: 'gruen' },
  ...
  { code: 'cv-RU', name: 'Tschuwaschisch', schrift: 'kyrillisch', qualitaet: 'gruen' },
  { code: 'ts-ZA', name: 'Tsonga', schrift: 'latein', qualitaet: 'gruen' },
  ...
  { code: 'tw-GH', name: 'Twi', schrift: 'latein', qualitaet: 'gruen' },
  { code: 'ug-CN', name: 'Uigurisch', schrift: 'arabisch', qualitaet: 'gruen' },
  ...
  { code: 'fy-NL', name: 'Westfriesisch', schrift: 'latein', qualitaet: 'gruen' },
  ...
  { code: 'yo-NG', name: 'Yoruba', schrift: 'latein', qualitaet: 'gruen' },
